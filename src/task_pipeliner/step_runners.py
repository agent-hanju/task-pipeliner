"""StepRunner classes — execute steps, manage queues, collect results."""
...
class InputStepRunner:
    ...
    def run(self) -> None:
        ...
        try:
            ...
            logger.info("input step runner finished step=%s", self._step_name)
...
class SequentialStepRunner(BaseStepRunner):
    ...
    def run(self) -> None:
        ...
        try:
            ...
            logger.info("step runner started step=%s", self.step_name)
            while True:
